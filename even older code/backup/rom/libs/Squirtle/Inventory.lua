...
function Inventory:reserve(id, quantity, damage)
    ...
    self._reserved[id .. ":" .. damage] = Squirtle.Item.new(id, quantity, damage)
end

function Inventory:dump(direction)
    local items = self:getItems()
    local item = Squirtle.Item.as(nil)
    local secured = { }
