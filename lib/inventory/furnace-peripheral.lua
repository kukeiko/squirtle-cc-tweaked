...
---@param furnace string
---@return integer
function FurnacePeripheral.getOutputCount(furnace)
    local fuelStack = FurnacePeripheral.getOutputStack(furnace)
...
---@param furnace string
---@return integer
function FurnacePeripheral.getFuelCount(furnace)
